...
class Resources {
    ...
    getResources(resourceType, resourceName, resourceGroupName) {
        return __awaiter(this, void 0, void 0, function* () {
            var queryParameters = !!resourceGroupName ? `$filter=resourceType EQ \'${encodeURIComponent(resourceType)}\' AND resourceGroup EQ \'${encodeURIComponent(resourceGroupName)}\' AND name EQ \'${encodeURIComponent(resourceName)}\'`
